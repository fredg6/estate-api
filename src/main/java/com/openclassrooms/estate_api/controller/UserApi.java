...
public interface UserApi {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "401", description = "Echec de l'authentification de l'utilisateur connecté", content = @Content(schema = @Schema(implementation = ResponseMessageDto.class)))
    })
